    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"Error" message:[NSString stringWithFormat:@"Album Error: %@ - %@", [error localizedDescription], [error localizedRecoverySuggestion]] delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
                [alert show];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSInteger gCount = [g numberOfAssets];
        NSString* albumName =[g valueForProperty:ALAssetsGroupPropertyName];
    if([albumName isEqualToString:@"All Photos"])
        albumName = @"全部图片";
    cell.textLabel.text = [NSString stringWithFormat:@"%@ (%ld)",albumName, (long)gCount];
